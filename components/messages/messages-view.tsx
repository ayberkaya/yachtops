  ...
  if (!selectedChannel) {
    return (
      <div className="flex h-full border rounded-lg overflow-hidden bg-background">
        ...
        <div className="hidden md:flex w-80 border-r border-border/50 flex-col bg-background/95 dark:bg-background/50 backdrop-blur-sm">
          <ChannelList
            channels={channels}
            selectedChannelId=""
  ...
  return (
    <div className="flex h-full border rounded-lg overflow-hidden bg-background">
      ...
      {/* Messages - Right Side */}
        ...
        {/* Header - Fixed */}
        <div className="border-b border-border/50 p-4 bg-background/95 dark:bg-background/70 backdrop-blur-xl backdrop-saturate-150 flex-shrink-0">
        ...
        <div 
          ...
          className="flex-1 overflow-y-auto p-4 min-h-0 bg-background/95 dark:bg-background/50 backdrop-blur-sm"
        >
          {isLoading && messages.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              {searchResults.map((message) => (
                <div key={message.id} className="border border-border/50 rounded-lg p-3 bg-background/95 dark:bg-background/60 backdrop-blur-sm">
                    ...
                    <div
                      className={`max-w-[70%] rounded-lg p-3 relative ${
                        isOwnMessage
                          ...
                          : "bg-background/95 dark:bg-background/50 backdrop-blur-sm"
        ...
        <div className="border-t border-border/50 p-4 bg-background/95 dark:bg-background/70 backdrop-blur-xl backdrop-saturate-150 flex-shrink-0">
          {replyingToMessageId && (
            <div className="mb-2 p-2 bg-background/95 dark:bg-background/60 backdrop-blur-sm rounded-lg flex items-center justify-between border border-border/30">
