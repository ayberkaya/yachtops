...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-green-500 data-[state=checked]:border-green-600 data-[state=checked]:hover:bg-green-600",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "dark:data-[state=checked]:bg-slate-50 dark:data-[state=unchecked]:bg-slate-50"
      )}
    />
  </SwitchPrimitives.Root>
))
