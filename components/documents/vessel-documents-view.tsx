...
interface VesselDocumentsViewProps {
  initialDocs: VesselDocument[];
}

export function VesselDocumentsView({ initialDocs }: VesselDocumentsViewProps) {
  const [docs, setDocs] = useState<VesselDocument[]>(initialDocs);
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Add Vessel Document</CardTitle>
          <CardDescription>
            Upload a document file (e.g. PDF or image) related to vessel documentation.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All vessel documents uploaded for this yacht.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {docs.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              No vessel documents uploaded yet.
            </p>
          ) : (
