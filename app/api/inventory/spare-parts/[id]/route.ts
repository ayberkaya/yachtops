...
const updateSchema = z.object({
  ...
  category: z.enum(["ENGINE", "ELECTRICAL", "PLUMBING", "DECK", "RIGGING", "SAFETY", "TOOLS", "OTHER"]).nullable().optional(),
...
export async function PATCH(
  ...
  const section = await getInventorySection(yachtId, "spareParts");
  ...
  await setInventorySection(yachtId, "spareParts", { items: nextItems, history: nextHistory });
...
export async function DELETE(
  ...
  await setInventorySection(yachtId, "spareParts", {
