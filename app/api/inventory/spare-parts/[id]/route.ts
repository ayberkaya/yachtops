...
export async function PATCH(
  ...
  try {
    ...
    // TODO: Replace with actual database update when SparePartStock model is created
...
export async function DELETE(
  ...
  try {
    ...
    // TODO: Replace with actual database delete when SparePartStock model is created
